                ...
                <div class="shop-sidebar">
                    <div class="shop-sidebar__content">
                        <div class="shop-sidebar__section -categories">
                            ...
                            <form method="GET" action="{{ route('PointMall') }}">
                            ...
                            <div class="shop-sidebar__section -categories">
                                ...
                                <ul class="all_categories" style="display: none;">
                                    ...
                                    <li>
                                        ...
                                        <div class="row">
                                            <div class="col-9">
                                                <a href="{{ route('PointMall', ['category='.urlencode($category->category_name),
                                                                                'brand='.request('brand'),
                                                                                'from='.request('from'),
                                                                                'to='.request('to'),
                            ...
                            <div class="shop-sidebar__section -categories">
                                ...
                                <ul class="all_brands" style="display: none;">
                                    @foreach($brands as $brand)
                                        <li>
                                            <a href="{{ route('PointMall', ['brand='.urlencode($brand->brand_name),
                ...
                <div class="form-group">
                    @if(!empty(request('result')))
                        <span class="badge bg-success p-2">
                            ...
                            <a href="{{ route('PointMall', ['category='.request('category'),
                                                            'brand='.request('brand'),
                                                            'from='.request('from'),
                    ...
                    @if(!empty(request('other_category')))
                        <span class="badge bg-success p-2">
                            ...
                            <a href="{{ route('PointMall', ['result='.request('result'),
                                                            'brand='.request('brand'),
                                                            'from='.request('from'),
                                                            'to='.request('to')]) }}" style="color: white;">
                                <i class="fa fa-times"></i>
                                ...
                                @foreach($products as $featured)
                                    <div class="col-sm-4 col-6 product-listing my-3 mb-px-5">
                                        <div class='container-box' style="font-size: 13px;" align="center">
                                            <a href="{{ route('details_mall', md5($featured->id)) }}">
                                                <div class="product ">
                                                        ...
                                                        <div class="product-content__footer" style="text-align: center; display: block;">
                                                            <h5 class="product-price--main h-33" style="font-size: 15px; color: #000 !important;">
                                                                ...
                                                                <div class="product__item__price {{ $special_price_available == '1' ? 'text-red' : '' }}">
                                                                    {!! $get_pricing[$featured->id]['product_price_range'] !!} {{ isset($data['lang']['lang']['point']) ? $data['lang']['lang']['point'] : 'Point' }}
                                                                    @if(!empty($original_pricing[$featured->id]['product_price_range']) && $original_pricing[$featured->id]['product_price_range'] != $get_pricing[$featured->id]['product_price_range'])
                                                                        <div class="product__item__price {{ $special_price_available == '1' ? 'text-grey' : '' }}">
                                                                            <small>
                                                                                <del>
                                                                                    {!! $original_pricing[$featured->id]['product_price_range'] !!} {{ isset($data['lang']['lang']['point']) ? $data['lang']['lang']['point'] : 'Point' }}
                                                                                </del>
                                                                            </small>
                                                                        </div>
                                                                    @elseif(!empty($get_pricing[$featured->id]['product_special_range']) && $get_pricing[$featured->id]['product_special_range'] != $get_pricing[$featured->id]['product_price_range'])
                                                                        <div class="product__item__price {{ $special_price_available == '1' ? 'text-grey' : '' }}">
                                                                            <small>
                                                                                <del>
                                                                                    {!! $get_pricing[$featured->id]['product_special_range'] !!} {{ isset($data['lang']['lang']['point']) ? $data['lang']['lang']['point'] : 'Point' }}
                                                                                </del>
                                                                            </small>
                                                                        </div>
                                                                    @endif
                    ...
                    if(response == 'ok'){
                        $.ajax({
                            ...
                            success: function(response){
                                ...
                                $('.cart_price').html(parseFloat(response[1]).toFixed(2)+'{{ isset($data["lang"]["lang"]["point"]) ? $data["lang"]["lang"]["point"] : "Point" }}');
...
<script type="text/javascript">
    ...
    $('.per_page').change(function(){
        var ele = $(this);
        var val = ele.val();
        var url = "{{ route('PointMall', ['per_page=:per_page']) }}";
